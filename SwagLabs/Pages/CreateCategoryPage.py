...
class CreateCategoryPage:
    ...
    create_category_link = (PATH, '//a[@href="category.php"]')

    category_name_textbox = (PATH, '//input[@name="category"]')
    description_textbox = (PATH, '//textarea[@class="span8"]')
    create_button = (PATH, '//button[@type="submit"]')
    ...
    def manage_product(self):
        ...
        wrapper.click_element(self.create_category_link)
        wrapper.drop_down(self.category_name_textbox)
        wrapper.enter_text(self.description_textbox)
